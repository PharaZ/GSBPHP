...
<div class="page-header"><h3>Rechercher un visiteur</h3></div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-3">
      <button type="submit" class="btn btn-primary" name="BTNValide" style="margin-top:20px;">Valider</button>
    </div>
  </div>
...
<div class="form-group">
<div class="col-sm-offset-2 col-sm-3">
  <button type="submit" class="btn btn-primary" name="BTNSubmit" style="margin-top:20px;">Valider</button>
</div>
</div>

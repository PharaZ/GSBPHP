...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 21 Avril 2015 à 18:31
...
INSERT INTO `compte` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `typeCompte`) VALUES
...
('a17', '201504', 0, '0.00', '2015-04-21', 'CR'),
('f39', '201504', 0, '0.00', '2015-04-21', 'VA'),
('f4', '201504', 0, '0.00', '2015-04-21', 'VA');
...
INSERT INTO `lignefraishorsforfait` (`id`, `idVisiteur`, `mois`, `libelle`, `date`, `montant`, `idEtat`) VALUES
(38, 'a17', '201504', 'test', '2015-04-21', '100.00', NULL),
(39, 'f39', '201504', 'fiche de frais', '2015-04-21', '90.00', 'RB'),
(40, 'f4', '201504', 'test3', '2015-04-21', '100.00', 'VA'),
(41, 'a17', '201504', 'test', '2015-04-22', '185.00', NULL);
...
INSERT INTO `typecompte` (`id`, `name`) VALUES
(1, 'Visiteur'),
(2, 'Comptable');
...
--
ALTER TABLE `compte`
  ADD CONSTRAINT `FK_compte_typecompte` FOREIGN KEY (`typeCompte`) REFERENCES `typecompte` (`id`);
...
ALTER TABLE `fichefrais`
  ...
  ADD CONSTRAINT `fichefrais_ibfk_2` FOREIGN KEY (`idVisiteur`) REFERENCES `compte` (`id`);
...
ALTER TABLE `lignefraishorsforfait`
  ...
  ADD CONSTRAINT `lignefraishorsforfait_ibfk_2` FOREIGN KEY (`idEtat`) REFERENCES `etat` (`id`);
